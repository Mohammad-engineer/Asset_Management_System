    ...
    >
        ...
        {logo ?? (
          <SvgIcon sx={{ width: 100, height: 100 }}>
            <svg
              ...
              width="800px"
              height="800px"
              viewBox="0 0 496.771 496.771"
            >
              <g>
                <path
                  d="M340.544,195.194c-6.693-11.595,3.586-30.002,22.83-41.119c19.244-11.117,40.402-10.758,47.096,0.836
      ...
      <Box
        ...
        sx={{
          ...
          height: 1,
          position: 'absolute',
          border: (theme) => `solid 4px ${theme.palette.text.primary}`,
        }}
      />
    </Box>
  );
...
export function AnimateLogo2({ logo, sx, ...other }) {
  ...
  return (
    ...
    >
      {logo ?? (
        <SvgIcon sx={{ zIndex: 9, width: 100, height: 100 }}>
        </SvgIcon>
      )}
      <Box
        component={m.div}
